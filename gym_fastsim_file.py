...
def eval_nn(genotype, nbstep=2000, dump=False, render=False, name=""):
    ...
    return math.sqrt((pos[0]-env.goalPos[0])**2+(pos[1]-env.goalPos[1])**2)## A completer: une evaluation devra renvoyer la fitness utilisée, mais aussi le descripteur comportemental résultant de cette évaluation
